// <fileinfo name="MarketingInfoCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="MarketingInfoCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="MarketingInfoCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class MarketingInfoCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Gets an array of all records from the <c>MarketingInfo</c> table.
		/// </summary>
		/// <returns>An array of <see cref="MarketingInfoRow"/> objects.</returns>
		public virtual MarketingInfoRow[] GetAll()
		{
		...
		/// includes all records from the <c>MarketingInfo</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>MarketingInfo</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="MarketingInfoRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="MarketingInfoRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public MarketingInfoRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			MarketingInfoRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="MarketingInfoRow"/> objects that 
		...
		/// <returns>An array of <see cref="MarketingInfoRow"/> objects.</returns>
		public MarketingInfoRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="MarketingInfoRow"/> objects.</returns>
		public virtual MarketingInfoRow[] GetAsArray(string whereSql, string orderBySql,
		...
		{
			string sql = "SELECT * FROM [dbo].[MarketingInfo]";
		...
		/// <summary>
		/// Gets <see cref="MarketingInfoRow"/> by the primary key.
		/// </summary>
		/// <param name="pkId">The <c>pkId</c> column value.</param>
		/// <returns>An instance of <see cref="MarketingInfoRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual MarketingInfoRow GetByPrimaryKey(int pkId)
		{
		...
		/// <summary>
		/// Updates the <c>MarketingInfo</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>MarketingInfo</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes a record from the <c>MarketingInfo</c> table using
		...
		/// <summary>
		/// Deletes <c>MarketingInfo</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>MarketingInfo</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[MarketingInfo]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>MarketingInfo</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="MarketingInfoRow"/> objects.</returns>
		protected MarketingInfoRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="MarketingInfoRow"/> objects.</returns>
		protected MarketingInfoRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// the <c>MarketingInfo</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "MarketingInfo";
			DataColumn dataColumn;
	...
	} // End of MarketingInfoCollection_Base class
}  // End of namespace
