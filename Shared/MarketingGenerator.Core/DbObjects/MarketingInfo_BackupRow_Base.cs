// <fileinfo name="MarketingInfo_BackupRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="MarketingInfo_BackupRow"/> that 
	/// represents a record in the <c>MarketingInfo_Backup</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="MarketingInfo_BackupRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class MarketingInfo_BackupRow_Base
	{
		private int _pkId;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MarketingInfo_BackupRow_Base"/> class.
		/// </summary>
		public MarketingInfo_BackupRow_Base()
		{
			// EMPTY
		}
	...
	} // End of MarketingInfo_BackupRow_Base class
} // End of namespace
