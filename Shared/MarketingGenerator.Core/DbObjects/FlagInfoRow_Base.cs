// <fileinfo name="FlagInfoRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FlagInfoRow"/> that 
	/// represents a record in the <c>FlagInfo</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="FlagInfoRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FlagInfoRow_Base
	{
		private int _pkId;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FlagInfoRow_Base"/> class.
		/// </summary>
		public FlagInfoRow_Base()
		{
			// EMPTY
		}
