// <fileinfo name="FlagCategoryCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FlagCategoryCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="FlagCategoryCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FlagCategoryCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FlagCategoryCollection_Base"/> 
		/// class with the specified <see cref="B2BProductCatalog"/>.
		/// </summary>
		/// <param name="db">The <see cref="B2BProductCatalog"/> object.</param>
		public FlagCategoryCollection_Base(B2BProductCatalog db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>FlagCategory</c> table.
		/// </summary>
		/// <returns>An array of <see cref="FlagCategoryRow"/> objects.</returns>
		public virtual FlagCategoryRow[] GetAll()
		{
		...
		/// includes all records from the <c>FlagCategory</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>FlagCategory</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="FlagCategoryRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="FlagCategoryRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public FlagCategoryRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			FlagCategoryRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="FlagCategoryRow"/> objects that 
		...
		/// <returns>An array of <see cref="FlagCategoryRow"/> objects.</returns>
		public FlagCategoryRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="FlagCategoryRow"/> objects.</returns>
		public virtual FlagCategoryRow[] GetAsArray(string whereSql, string orderBySql,
		...
		{
			string sql = "SELECT * FROM [dbo].[FlagCategory]";
		...
		/// <summary>
		/// Gets <see cref="FlagCategoryRow"/> by the primary key.
		/// </summary>
		/// <param name="pkId">The <c>pkId</c> column value.</param>
		/// <returns>An instance of <see cref="FlagCategoryRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual FlagCategoryRow GetByPrimaryKey(int pkId)
		{
		...
		/// <summary>
		/// Updates the <c>FlagCategory</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>FlagCategory</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes a record from the <c>FlagCategory</c> table using
		...
		/// <summary>
		/// Deletes <c>FlagCategory</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>FlagCategory</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[FlagCategory]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>FlagCategory</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="FlagCategoryRow"/> objects.</returns>
		protected FlagCategoryRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="FlagCategoryRow"/> objects.</returns>
		protected FlagCategoryRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// the <c>FlagCategory</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "FlagCategory";
			DataColumn dataColumn;
	...
	} // End of FlagCategoryCollection_Base class
}  // End of namespace
