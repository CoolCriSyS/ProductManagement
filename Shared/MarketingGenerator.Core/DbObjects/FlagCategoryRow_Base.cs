// <fileinfo name="FlagCategoryRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FlagCategoryRow"/> that 
	/// represents a record in the <c>FlagCategory</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="FlagCategoryRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FlagCategoryRow_Base
	{
		private int _pkId;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FlagCategoryRow_Base"/> class.
		/// </summary>
		public FlagCategoryRow_Base()
		{
			// EMPTY
		}
	...
	} // End of FlagCategoryRow_Base class
} // End of namespace
