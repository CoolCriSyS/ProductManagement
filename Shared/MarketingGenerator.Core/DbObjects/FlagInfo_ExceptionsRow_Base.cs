// <fileinfo name="FlagInfo_ExceptionsRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FlagInfo_ExceptionsRow"/> that 
	/// represents a record in the <c>FlagInfo_Exceptions</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="FlagInfo_ExceptionsRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FlagInfo_ExceptionsRow_Base
	{
		private int _pkId;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FlagInfo_ExceptionsRow_Base"/> class.
		/// </summary>
		public FlagInfo_ExceptionsRow_Base()
		{
			// EMPTY
		}
	...
	} // End of FlagInfo_ExceptionsRow_Base class
} // End of namespace
