// <fileinfo name="MarketingInfo_ExceptionsCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="MarketingInfo_ExceptionsCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="MarketingInfo_ExceptionsCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class MarketingInfo_ExceptionsCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MarketingInfo_ExceptionsCollection_Base"/> 
		/// class with the specified <see cref="B2BProductCatalog"/>.
		/// </summary>
		/// <param name="db">The <see cref="B2BProductCatalog"/> object.</param>
		public MarketingInfo_ExceptionsCollection_Base(B2BProductCatalog db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>MarketingInfo_Exceptions</c> table.
		/// </summary>
		/// <returns>An array of <see cref="MarketingInfo_ExceptionsRow"/> objects.</returns>
		public virtual MarketingInfo_ExceptionsRow[] GetAll()
		{
		...
		/// includes all records from the <c>MarketingInfo_Exceptions</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>MarketingInfo_Exceptions</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="MarketingInfo_ExceptionsRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="MarketingInfo_ExceptionsRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public MarketingInfo_ExceptionsRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			MarketingInfo_ExceptionsRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="MarketingInfo_ExceptionsRow"/> objects that 
		...
		/// <returns>An array of <see cref="MarketingInfo_ExceptionsRow"/> objects.</returns>
		public MarketingInfo_ExceptionsRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="MarketingInfo_ExceptionsRow"/> objects.</returns>
		public virtual MarketingInfo_ExceptionsRow[] GetAsArray(string whereSql, string orderBySql,
		...
		{
			string sql = "SELECT * FROM [dbo].[MarketingInfo_Exceptions]";
		...
		/// <summary>
		/// Gets <see cref="MarketingInfo_ExceptionsRow"/> by the primary key.
		/// </summary>
		/// <param name="pkId">The <c>pkId</c> column value.</param>
		/// <returns>An instance of <see cref="MarketingInfo_ExceptionsRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual MarketingInfo_ExceptionsRow GetByPrimaryKey(int pkId)
		{
			string whereSql = "[pkId]=" + _db.CreateSqlParameterName("PkId");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "PkId", pkId);
			MarketingInfo_ExceptionsRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Adds a new record into the <c>MarketingInfo_Exceptions</c> table.
		/// </summary>
		/// <param name="value">The <see cref="MarketingInfo_ExceptionsRow"/> object to be inserted.</param>
		public virtual void Insert(MarketingInfo_ExceptionsRow value)
		{
			string sqlStr = "INSERT INTO [dbo].[MarketingInfo_Exceptions] (" +
				"[StyleNumber], " +
				"[SalesOrg], " +
				"[DistributionChannel], " +
				"[MarketingDescEn], " +
		...
		/// <summary>
		/// Updates a record in the <c>MarketingInfo_Exceptions</c> table.
		/// </summary>
		/// <param name="value">The <see cref="MarketingInfo_ExceptionsRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(MarketingInfo_ExceptionsRow value)
		{
			string sqlStr = "UPDATE [dbo].[MarketingInfo_Exceptions] SET " +
		...
		/// <summary>
		/// Updates the <c>MarketingInfo_Exceptions</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>MarketingInfo_Exceptions</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>MarketingInfo_Exceptions</c> table.
		/// </summary>
		/// <param name="value">The <see cref="MarketingInfo_ExceptionsRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(MarketingInfo_ExceptionsRow value)
		{
			return DeleteByPrimaryKey(value.PkId);
		}

		/// <summary>
		/// Deletes a record from the <c>MarketingInfo_Exceptions</c> table using
		...
		/// <summary>
		/// Deletes <c>MarketingInfo_Exceptions</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>MarketingInfo_Exceptions</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[MarketingInfo_Exceptions]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>MarketingInfo_Exceptions</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="MarketingInfo_ExceptionsRow"/> objects.</returns>
		protected MarketingInfo_ExceptionsRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="MarketingInfo_ExceptionsRow"/> objects.</returns>
		protected MarketingInfo_ExceptionsRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="MarketingInfo_ExceptionsRow"/> objects.</returns>
		protected virtual MarketingInfo_ExceptionsRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					MarketingInfo_ExceptionsRow record = new MarketingInfo_ExceptionsRow();
			...
			return (MarketingInfo_ExceptionsRow[])(recordList.ToArray(typeof(MarketingInfo_ExceptionsRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="MarketingInfo_ExceptionsRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="MarketingInfo_ExceptionsRow"/> object.</returns>
		protected virtual MarketingInfo_ExceptionsRow MapRow(DataRow row)
		{
			MarketingInfo_ExceptionsRow mappedObject = new MarketingInfo_ExceptionsRow();
		...
		/// the <c>MarketingInfo_Exceptions</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "MarketingInfo_Exceptions";
			DataColumn dataColumn;
	...
	} // End of MarketingInfo_ExceptionsCollection_Base class
}  // End of namespace
