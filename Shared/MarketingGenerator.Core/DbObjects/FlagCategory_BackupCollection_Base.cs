// <fileinfo name="FlagCategory_BackupCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FlagCategory_BackupCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="FlagCategory_BackupCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FlagCategory_BackupCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Gets an array of all records from the <c>FlagCategory_Backup</c> table.
		/// </summary>
		/// <returns>An array of <see cref="FlagCategory_BackupRow"/> objects.</returns>
		public virtual FlagCategory_BackupRow[] GetAll()
		{
		...
		/// includes all records from the <c>FlagCategory_Backup</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>FlagCategory_Backup</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="FlagCategory_BackupRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="FlagCategory_BackupRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public FlagCategory_BackupRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			FlagCategory_BackupRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="FlagCategory_BackupRow"/> objects that 
		...
		/// <returns>An array of <see cref="FlagCategory_BackupRow"/> objects.</returns>
		public FlagCategory_BackupRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="FlagCategory_BackupRow"/> objects.</returns>
		public virtual FlagCategory_BackupRow[] GetAsArray(string whereSql, string orderBySql,
		...
		{
			string sql = "SELECT * FROM [dbo].[FlagCategory_Backup]";
		...
		/// <summary>
		/// Gets <see cref="FlagCategory_BackupRow"/> by the primary key.
		/// </summary>
		/// <param name="pkId">The <c>pkId</c> column value.</param>
		/// <returns>An instance of <see cref="FlagCategory_BackupRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual FlagCategory_BackupRow GetByPrimaryKey(int pkId)
		{
			string whereSql = "[pkId]=" + _db.CreateSqlParameterName("PkId");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "PkId", pkId);
			FlagCategory_BackupRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Adds a new record into the <c>FlagCategory_Backup</c> table.
		/// </summary>
		/// <param name="value">The <see cref="FlagCategory_BackupRow"/> object to be inserted.</param>
		public virtual void Insert(FlagCategory_BackupRow value)
		{
			string sqlStr = "INSERT INTO [dbo].[FlagCategory_Backup] (" +
				"[Category], " +
				"[CategoryFr], " +
				"[CategoryId], " +
				"[Sequence], " +
		...
		/// <summary>
		/// Updates a record in the <c>FlagCategory_Backup</c> table.
		/// </summary>
		/// <param name="value">The <see cref="FlagCategory_BackupRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(FlagCategory_BackupRow value)
		{
			string sqlStr = "UPDATE [dbo].[FlagCategory_Backup] SET " +
		...
		/// <summary>
		/// Updates the <c>FlagCategory_Backup</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>FlagCategory_Backup</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>FlagCategory_Backup</c> table.
		/// </summary>
		/// <param name="value">The <see cref="FlagCategory_BackupRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(FlagCategory_BackupRow value)
		{
			return DeleteByPrimaryKey(value.PkId);
		}

		/// <summary>
		/// Deletes a record from the <c>FlagCategory_Backup</c> table using
		...
		/// <summary>
		/// Deletes <c>FlagCategory_Backup</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>FlagCategory_Backup</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[FlagCategory_Backup]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>FlagCategory_Backup</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="FlagCategory_BackupRow"/> objects.</returns>
		protected FlagCategory_BackupRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="FlagCategory_BackupRow"/> objects.</returns>
		protected FlagCategory_BackupRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="FlagCategory_BackupRow"/> objects.</returns>
		protected virtual FlagCategory_BackupRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					FlagCategory_BackupRow record = new FlagCategory_BackupRow();
			...
			return (FlagCategory_BackupRow[])(recordList.ToArray(typeof(FlagCategory_BackupRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="FlagCategory_BackupRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="FlagCategory_BackupRow"/> object.</returns>
		protected virtual FlagCategory_BackupRow MapRow(DataRow row)
		{
			FlagCategory_BackupRow mappedObject = new FlagCategory_BackupRow();
		...
		/// the <c>FlagCategory_Backup</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "FlagCategory_Backup";
			DataColumn dataColumn;
	...
	} // End of FlagCategory_BackupCollection_Base class
}  // End of namespace
