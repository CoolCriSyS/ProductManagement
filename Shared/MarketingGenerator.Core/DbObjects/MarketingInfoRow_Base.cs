// <fileinfo name="MarketingInfoRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="MarketingInfoRow"/> that 
	/// represents a record in the <c>MarketingInfo</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="MarketingInfoRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class MarketingInfoRow_Base
	{
		private int _pkId;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MarketingInfoRow_Base"/> class.
		/// </summary>
		public MarketingInfoRow_Base()
		{
			// EMPTY
		}
	...
	} // End of MarketingInfoRow_Base class
} // End of namespace
