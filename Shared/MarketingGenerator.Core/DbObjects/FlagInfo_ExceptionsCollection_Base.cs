// <fileinfo name="FlagInfo_ExceptionsCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FlagInfo_ExceptionsCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="FlagInfo_ExceptionsCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FlagInfo_ExceptionsCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FlagInfo_ExceptionsCollection_Base"/> 
		/// class with the specified <see cref="B2BProductCatalog"/>.
		/// </summary>
		/// <param name="db">The <see cref="B2BProductCatalog"/> object.</param>
		public FlagInfo_ExceptionsCollection_Base(B2BProductCatalog db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>FlagInfo_Exceptions</c> table.
		/// </summary>
		/// <returns>An array of <see cref="FlagInfo_ExceptionsRow"/> objects.</returns>
		public virtual FlagInfo_ExceptionsRow[] GetAll()
		{
		...
		/// includes all records from the <c>FlagInfo_Exceptions</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>FlagInfo_Exceptions</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="FlagInfo_ExceptionsRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="FlagInfo_ExceptionsRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public FlagInfo_ExceptionsRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			FlagInfo_ExceptionsRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="FlagInfo_ExceptionsRow"/> objects that 
		...
		/// <returns>An array of <see cref="FlagInfo_ExceptionsRow"/> objects.</returns>
		public FlagInfo_ExceptionsRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="FlagInfo_ExceptionsRow"/> objects.</returns>
		public virtual FlagInfo_ExceptionsRow[] GetAsArray(string whereSql, string orderBySql,
		...
		{
			string sql = "SELECT * FROM [dbo].[FlagInfo_Exceptions]";
		...
		/// <summary>
		/// Gets <see cref="FlagInfo_ExceptionsRow"/> by the primary key.
		/// </summary>
		/// <param name="pkId">The <c>pkId</c> column value.</param>
		/// <returns>An instance of <see cref="FlagInfo_ExceptionsRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual FlagInfo_ExceptionsRow GetByPrimaryKey(int pkId)
		{
			string whereSql = "[pkId]=" + _db.CreateSqlParameterName("PkId");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "PkId", pkId);
			FlagInfo_ExceptionsRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Adds a new record into the <c>FlagInfo_Exceptions</c> table.
		/// </summary>
		/// <param name="value">The <see cref="FlagInfo_ExceptionsRow"/> object to be inserted.</param>
		public virtual void Insert(FlagInfo_ExceptionsRow value)
		{
			string sqlStr = "INSERT INTO [dbo].[FlagInfo_Exceptions] (" +
				"[FlagId], " +
				"[FlagName], " +
				"[FlagNameFr], " +
				"[FlagDescription], " +
		...
		/// <summary>
		/// Updates a record in the <c>FlagInfo_Exceptions</c> table.
		/// </summary>
		/// <param name="value">The <see cref="FlagInfo_ExceptionsRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(FlagInfo_ExceptionsRow value)
		{
			string sqlStr = "UPDATE [dbo].[FlagInfo_Exceptions] SET " +
		...
		/// <summary>
		/// Updates the <c>FlagInfo_Exceptions</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>FlagInfo_Exceptions</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>FlagInfo_Exceptions</c> table.
		/// </summary>
		/// <param name="value">The <see cref="FlagInfo_ExceptionsRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(FlagInfo_ExceptionsRow value)
		{
			return DeleteByPrimaryKey(value.PkId);
		}

		/// <summary>
		/// Deletes a record from the <c>FlagInfo_Exceptions</c> table using
		...
		/// <summary>
		/// Deletes <c>FlagInfo_Exceptions</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>FlagInfo_Exceptions</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[FlagInfo_Exceptions]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>FlagInfo_Exceptions</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="FlagInfo_ExceptionsRow"/> objects.</returns>
		protected FlagInfo_ExceptionsRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="FlagInfo_ExceptionsRow"/> objects.</returns>
		protected FlagInfo_ExceptionsRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="FlagInfo_ExceptionsRow"/> objects.</returns>
		protected virtual FlagInfo_ExceptionsRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					FlagInfo_ExceptionsRow record = new FlagInfo_ExceptionsRow();
			...
			return (FlagInfo_ExceptionsRow[])(recordList.ToArray(typeof(FlagInfo_ExceptionsRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="FlagInfo_ExceptionsRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="FlagInfo_ExceptionsRow"/> object.</returns>
		protected virtual FlagInfo_ExceptionsRow MapRow(DataRow row)
		{
			FlagInfo_ExceptionsRow mappedObject = new FlagInfo_ExceptionsRow();
		...
		/// the <c>FlagInfo_Exceptions</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "FlagInfo_Exceptions";
			DataColumn dataColumn;
	...
	} // End of FlagInfo_ExceptionsCollection_Base class
}  // End of namespace
