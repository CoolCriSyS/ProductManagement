// <fileinfo name="FlagInfo_BackupCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FlagInfo_BackupCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="FlagInfo_BackupCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FlagInfo_BackupCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FlagInfo_BackupCollection_Base"/> 
		/// class with the specified <see cref="B2BProductCatalog"/>.
		/// </summary>
		/// <param name="db">The <see cref="B2BProductCatalog"/> object.</param>
		public FlagInfo_BackupCollection_Base(B2BProductCatalog db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>FlagInfo_Backup</c> table.
		/// </summary>
		/// <returns>An array of <see cref="FlagInfo_BackupRow"/> objects.</returns>
		public virtual FlagInfo_BackupRow[] GetAll()
		{
		...
		/// includes all records from the <c>FlagInfo_Backup</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>FlagInfo_Backup</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="FlagInfo_BackupRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="FlagInfo_BackupRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public FlagInfo_BackupRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			FlagInfo_BackupRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="FlagInfo_BackupRow"/> objects that 
		...
		/// <returns>An array of <see cref="FlagInfo_BackupRow"/> objects.</returns>
		public FlagInfo_BackupRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="FlagInfo_BackupRow"/> objects.</returns>
		public virtual FlagInfo_BackupRow[] GetAsArray(string whereSql, string orderBySql,
		...
		{
			string sql = "SELECT * FROM [dbo].[FlagInfo_Backup]";
		...
		/// <summary>
		/// Gets <see cref="FlagInfo_BackupRow"/> by the primary key.
		/// </summary>
		/// <param name="pkId">The <c>pkId</c> column value.</param>
		/// <returns>An instance of <see cref="FlagInfo_BackupRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual FlagInfo_BackupRow GetByPrimaryKey(int pkId)
		{
			string whereSql = "[pkId]=" + _db.CreateSqlParameterName("PkId");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "PkId", pkId);
			FlagInfo_BackupRow[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Updates the <c>FlagInfo_Backup</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>FlagInfo_Backup</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes a record from the <c>FlagInfo_Backup</c> table using
		...
		/// <summary>
		/// Deletes <c>FlagInfo_Backup</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>FlagInfo_Backup</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[FlagInfo_Backup]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>FlagInfo_Backup</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="FlagInfo_BackupRow"/> objects.</returns>
		protected FlagInfo_BackupRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="FlagInfo_BackupRow"/> objects.</returns>
		protected FlagInfo_BackupRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// the <c>FlagInfo_Backup</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "FlagInfo_Backup";
			DataColumn dataColumn;
	...
	} // End of FlagInfo_BackupCollection_Base class
}  // End of namespace
